...
$exam= "NomExam";
$sess= "AnnéSession";
$desc="J'ai l'honeur de vous demmander de vous présenter à l'heur indiquée munié de cette convocation et d'une piéce d'identité en cours de validité (photographie récente de préfèrence) aux lieux, dates et horraires indiqués ci-dessous.";
$titreGCadre="Lycee jean rostand - ...";
...
// Affiche : mardi 11 septembre 2001.
 $datefin = dateToFrench($epreuve->jourE,'l j F Y');
  ...
  $pdf->SetXY(30, 100);
  $pdf->MultiCell(150, 5,utf8_decode("Convocation générer : ".$nbConvoc),0, "L");
