                    ...
                    //----------------------------------------------------
                        ...
                        foreach($lesEnregs as $enreg){
                            ...
                            if($enreg->idProfChoix != null && ($_POST['idProf']==$enreg->idProfChoix)){
                                 echo"<td><input type='checkbox' checked name='sel$enreg->idEp' id='sel$enreg->idEp' value='$enreg->idEp' /></td>";
                            }
                            else{
                                echo "<td> <input type='checkbox' name='sel$enreg->idEp' id='selectionner' value='$enreg->idEp' /></td>";  
                            }
