...
//include "session_admin.php";
 include "connexion_bd_gesoraux.php";
  $msg ="";
  //on initialise les variables utilisés
    ...
    if($msg=="")
    {
      ...
      try {
        ...
        :par_civilite,)");
                ...
                header('Location: gestion_prof_admin.php?msg='.$msg);
            
            } catch(PDOException $e){
              echo("Err BDInsert  : erreur ajout table utilisateur dans prof_ajout.php<br>
...
<html lang="fr" dir="ltr">
  ...
  <body>
    <div class="container">
      <form class="" action = "prof_ajout.php" method="post">
