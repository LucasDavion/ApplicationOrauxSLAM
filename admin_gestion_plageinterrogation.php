  ...
  <div class=container>
		...
		<div class=form-group>
			...
			try{
				...
				$lesEnregs=$bdd->query("select * from plage");
			...
			if($lesEnregs->rowCount()==0){
				...
				foreach ($lesEnregs as $enreg) {
					...
					// redirection vers admin_gestion_plageinterrogation_modification.php
					echo"<td><a href='admin_gestion_plageinterrogation_modification.php?id=$enreg->id'><input type='submit' class='btn btn-primary' name='btn_modif' value='modif' /></a></td>";
					// redirection vers admin_gestion_plageinterrogation_suppression.php
					echo "<td><a href='admin_gestion_plageinterrogation_suppression.php?id=$enreg->id' onclick='return confirmer_suppres();'><input type='submit' class='btn btn-danger' name='btn_supp' value='supp' /></a></td>";
					echo"</tr>";
				}
				echo "</table><br><br>";
			}
